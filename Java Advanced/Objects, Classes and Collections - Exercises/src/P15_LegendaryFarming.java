...
public class P15_LegendaryFarming {
    public static void main(String[] args) {
        ...
        keyItems.entrySet().stream().sorted((c1, c2) -> keyItems.get(c2.getKey()).compareTo(keyItems.get(c1.getKey()))).forEach(item -> System.out.printf("%s: %d\n", item.getKey(), item.getValue()));
    ...
    private static boolean isKeyItem(String material) {
        if (material.equals("shards") || material.equals("fragments") || material.equals("motes")) return true;
